    ...
    >
      ...
      >
        ...
        <div className="space-y-2">
          ...
          {confirmRestore ? (
            <div className="rounded-lg border border-violet-300 dark:border-violet-700 bg-violet-50 dark:bg-violet-900/20 p-3 space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-1.5 rounded-lg text-xs font-medium bg-violet-600 text-white hover:bg-violet-700 transition-colors"
                >
                  Ja, wiederherstellen
                </button>
              </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 rounded-lg text-sm font-medium transition-colors border border-violet-200 dark:border-violet-800 text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {backupState === 'loading' ? (
