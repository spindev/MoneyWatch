        ...
        <div className="space-y-2">
          ...
          <label className="block">
            ...
            <input
              ...
              className="mt-1 w-full px-3 py-2 rounded-lg text-sm border border-gray-200 dark:border-slate-600 bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </label>
        </div>
          ...
          {confirmClear ? (
            <div className="rounded-lg border border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/20 p-3 space-y-2">
              <p className="text-red-700 dark:text-red-300 text-xs">
                Alle erfassten Ausgaben werden unwiderruflich gelöscht. Fortfahren?
              </p>
              <div className="flex gap-2">
                <button
