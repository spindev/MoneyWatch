...
// Loaded from src/apps/portfolio/etfs.json — the same file read by scripts/fetch-finance-data.mjs
...
//     BASE_URL is '/MoneyWatch/' in production (see vite.config.ts).
...
export function buildPortfolioHistory(
  ...
  // Only include dates where every ETF with data has at least a forward-filled price.
