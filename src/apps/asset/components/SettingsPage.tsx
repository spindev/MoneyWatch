          ...
          {confirmClear ? (
            <div className="rounded-lg border border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/20 p-3 space-y-2">
              <p className="text-red-700 dark:text-red-300 text-xs">
                Alle erfassten Anlagen werden unwiderruflich gelöscht. Fortfahren?
              </p>
              <div className="flex gap-2">
                <button
          ...
          {confirmRestore ? (
            <div className="rounded-lg border border-emerald-300 dark:border-emerald-700 bg-emerald-50 dark:bg-emerald-900/20 p-3 space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-1.5 rounded-lg text-xs font-medium bg-emerald-600 text-white hover:bg-emerald-700 transition-colors"
                >
                  Ja, wiederherstellen
                </button>
              </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 rounded-lg text-sm font-medium transition-colors border border-emerald-200 dark:border-emerald-800 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {backupState === 'loading' ? (
