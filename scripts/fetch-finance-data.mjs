 ...
 * Tickers are kept in sync with DEMO_ETFS in src/apps/portfolio/etfs.json.
 */
...
// Load tickers from src/apps/portfolio/etfs.json — the single source of truth shared with
// src/apps/portfolio/services/financeService.ts. Add or rename a ticker there and this script
// automatically picks it up on the next deployment.
const etfs = JSON.parse(readFileSync(join(__dirname, '..', 'src', 'apps', 'portfolio', 'etfs.json'), 'utf8'));
